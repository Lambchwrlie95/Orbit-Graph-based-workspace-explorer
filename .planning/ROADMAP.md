...
- [ ] **Phase 1: Workspace Index Foundation** - Open a workspace, scan files, and persist metadata in SQLite.
- [ ] **Phase 2: Explorer, Search, and Inspector** - Make indexed files usable through normal browsing, filename search, selection, preview, and open actions.
- [ ] **Phase 3: Scoped Graph Core** - Render the active scope as an interactive graph connected to selection and open/focus actions.
- [ ] **Phase 4: Performance Guardrails** - Enforce lazy loading, background work, cache reuse, and graph caps for large folders.
...
|-------|----------------|--------|-----------|
| 1. Workspace Index Foundation | 0/3 | Not started | - |
| 2. Explorer, Search, and Inspector | 0/3 | Not started | - |
| 3. Scoped Graph Core | 0/3 | Not started | - |
| 4. Performance Guardrails | 0/2 | Not started | - |
